...
# Air Pollution & Aerosols Data Metadata

## Data Source

The air pollution and aerosol data used in this project is obtained from NASA's MERRA-2 (Modern-Era Retrospective analysis for Research and Applications, Version 2) atmospheric aerosol profile datastore `tavgM_2d_aer_Nx`:

[NASA GES DISC MERRA-2 Datasets](https://disc.gsfc.nasa.gov/datasets?project=MERRA-2)

## Features and Metadata

Below are the main air pollution and aerosol features included, their descriptions, and units:
