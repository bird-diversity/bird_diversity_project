...
*   **`BCSMASS`**: Black Carbon Surface Mass Concentration. Tracks fine particulate matter resulting from incomplete combustion.
*   **`OCSMASS`**: Organic Carbon Surface Mass Concentration. Carbon-based aerosol particles.
*   **`DUSMASS`**: Dust Surface Mass Concentration. Total dust aerosol mass.
*   **`DUEXTT25`**: Dust Extinction. A measure of how much dust particles in the air scatter and absorb light.
*   **`SO2SMASS`**: Sulfur Dioxide Surface Mass Concentration. A pollutant gas primarily from volcanic and industrial activity.
*   **`SO4SMASS`**: Sulfate Surface Mass Concentration. Aerosol particles formed from sulfur dioxide oxidation.
*   **`SSSMASS`**: Sea Salt Surface Mass Concentration. Airborne salt particles generated by wind over oceans.
*   **`TOTEXTTAU`**: Total Aerosol Extinction Optical Thickness (AOD - Aerosol Optical Depth). A comprehensive measure of how much total sunlight is prevented from reaching the ground by all aerosol types.
*   **`TOTSCATAU`**: Total Aerosol Scattering Optical Thickness. Similar to TOTEXTTAU, but specifically measures the scattering component of the aerosols.
